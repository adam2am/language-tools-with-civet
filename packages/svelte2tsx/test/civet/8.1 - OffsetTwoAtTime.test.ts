...
describe('8.1 - OffsetTwoAtTime: braceless vs braced offset analysis #current', () => {
  const fixtures: Array<{ name: string; token: string; expectOffset?: number }> = [
    { name: 'LazerFocus2-issue3.svelte', token: 'foo2', expectOffset: 2 },       // Braceless function
    { name: 'LazerFocus2-issue3-nooffset.svelte', token: 'foo2', expectOffset: 1 } // Braced function
  ];
